...
const bio = `<p>
👋 <strong>I&apos;m Sumit</strong>, a Full Stack Developer from India. Passionate about crafting captivating digital experiences through code, I am a skilled Full Stack Developer with a keen eye for design & a knack for turning ideas into interactive web solutions.
</p>`;
...
const services = [
	...
	},
	{
		...
		desc: "I offer collaboration opportunities, including sharing your post on my LinkedIn account with 17k+ followers to help boost visibility and reach.",
	},
	{
		...
		<Layout bg={'gradient'}>
			...
			<Home>
				...
				<div className='profile no-photo'>
					...
					<div
						className='slide'
						style={{ backgroundImage: 'url(images/avatar3_sumit.jpg)' }}
					/>
					{/* profile titles */}
					<div className='title'>Sumit Vishwakarma</div>
