					...
					<div className="col col-d-6 col-t-6 col-m-12 border-line-v">
						...
						<div className="resume-items">
							<div className="resume-item border-line-h active">
								<div className="date">September 2024 - Present</div>
								<div className="name">Levitation Infotech</div>
								<div className="company">Internship (Full Stack Developer)</div>
								<p>
								I am currently working on converting Figma designs into pixel-perfect code, integrating APIs, and contributing to CMS projects. My work involves utilizing technologies such as React.js, ShadCN, React Query, JavaScript, HTML, and Tailwind CSS to deliver high-quality, responsive user interfaces.
								</p>
							</div>
							<div className="resume-item border-line-h">
								<div className="date">Jan 2024 - July 2024</div>
								<div className="name">Newzera (Zangoh)</div>
								<div className="company">Internship (Full Stack Developer)</div>
								<ul>
							<li>	• Spearheaded backend API Development and frontend
 UI design for 3 repositories, delivering 40+ pull requests.</li>
 <li>• Enhanced code quality by 30% and reduced bug reports
 by 25%. </li>
 <li>• Improved site responsiveness and ensured production
 readiness for 2 websites. </li>
<li>• Designed pages based on Figma designs,  increasing
user engagement by 40%. </li>
<li>• Tech Stack: Next.js, React.js, Medusa.js, JavaScript,
TypeScript, Tailwind, Docker</li>
					...
					<div className="col col-d-6 col-t-6 col-m-12 border-line-v">
						...
						<div className="resume-items">
							<div className="resume-item border-line-h">
								<div className="date">Dec 2020 - May 2024</div>
								<div className="name">Shri Govindram Secksaria Institute of Technology & Science</div>
								<div className="company">B.Tech (CGPA - 7.86/10)</div>
							
							</div>
							<div className="resume-item border-line-h">
								<div className="name">Jawahar Navodaya Vidyalaya</div>
								<div className="company">Intermediate(PCM) - (85%/100%)</div>
							</div>
						</div>
					</div>
					<div className="clear" />
