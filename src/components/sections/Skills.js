				...
				<div className="row">
					...
					<div className="col col-d-6 col-t-6 col-m-12 border-line-v">
						<div className="skills-list">
							...
							<ul>
								...
								<li className="border-line-h">
									<div className="name">Node.js & Express.js</div>
									<div className="progress">
										<div className="percentage" style={{ width: "80%" }} />
									</div>
								</li>
								<li className="border-line-h">
									<div className="name">Database(SQL/NoSQL)</div>
									<div className="progress">
										<div className="percentage" style={{ width: "85%" }} />
									</div>
								</li>
					...
					<div className="col col-d-6 col-t-6 col-m-12 border-line-v">
						<div className="skills-list circles">
							...
							<ul>
								...
								<li>
									<div className="name">CSS / SCSS / Tailwind CSS</div>
					...
					<div className="col col-d-6 col-t-6 col-m-12 border-line-v">
						<div className="skills-list list">
							...
							<ul>
								<li>
									<div className="name">Website Designing</div>
								</li>
								<li>
